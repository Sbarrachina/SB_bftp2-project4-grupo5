...
public class SampleDataLoader {
    ...
    public void loadSampleData() {
        legacyGameRepository.saveAll(List.of(
                ...
                new Game("Duck Hunt", "Nes", 1984, "Shooter", 12, 99.99, "https://i.ibb.co/VY2MZBF/foto-Muestra.png" ),
                new Game("Nintendogs", "DS", 2005, "Simulation", 3, 28.9,  "https://i.ibb.co/VY2MZBF/foto-Muestra.png"),
                new Game("Halo 3", "X360", 2007, "Shooter", 12 , 35.99, "https://i.ibb.co/VY2MZBF/foto-Muestra.png" ),
                new Game( "Super Mario Galaxy", "Wii",2007, "Fantasy",7, 70, "https://i.ibb.co/VY2MZBF/foto-Muestra.png"),
                ...
                new Game("Minecraft", "X360", 2013, "Misc", 7 ,23.99 , "https://i.ibb.co/VY2MZBF/foto-Muestra.png")
